...
/** Demo seed groups: practice content, never real ledgers. Blocked in enforced mode. */
export function isDemoGroupId(groupId) {
  return groupId === 'bakwata-01' || groupId === 'kibuli-01';
}

export function toGroupSummary(s) {  return {
    id: s.groupId,
